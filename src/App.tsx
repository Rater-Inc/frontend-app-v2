...
const RedirectToSelectAction = () => {
  const { spaceId } = useParams();
  return <Navigate to={`/space/${spaceId}/select-action`} />;
};
      ...
      <div className="relative z-10">
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/enter-space" element={<EnterSpaceIdPage />} />
            <Route path="/join/:spaceId" element={<JoinSpacePage />} />
            <Route
              path="/space/:spaceId"
              element={<RedirectToSelectAction />}
            />
            <Route
